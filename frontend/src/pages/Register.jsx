    ...
    <div style={s.root}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .submit-btn:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 8px 24px rgba(201,168,76,0.35); }
        ...
        <div style={s.left}>
          ...
          <div style={s.leftContent}>
            ...
            <div style={s.leftMain}>
              <h1 style={s.leftH1}>
                Your rights.<br />
                <em style={s.leftEm}>Protected by AI.</em>
              </h1>
              <p style={s.leftP}>
                Join thousands of Indian citizens who use LexOS
                to understand their legal rights and take action.
              </p>
              <div style={s.statsList}>
                {[
                  { v: '9+', l: 'AI-powered features' },
                  { v: '₹0', l: 'Completely free' },
                  { v: '100%', l: 'India-specific laws' },
                ].map((st, i) => (
            ...
            <div style={s.leftQuote}>
              ...
              <p style={s.quoteText}>Where law ends, tyranny begins.</p>
              <p style={s.quoteAuthor}>— John Locke</p>
            </div>
          </div>
        </div>
        ...
        <div style={s.right}>
          <div style={s.formWrap}>
            <div style={s.formHead}>
              <div style={s.eyebrow}>
                <span style={{ width:6, height:6, borderRadius:'50%', background:'#C9A84C', display:'inline-block', animation:'goldPulse 2.5s ease infinite' }} />
                <span style={s.eyebrowText}>Get started free</span>
              </div>
            ...
            <form onSubmit={handleSubmit} style={s.form}>
              <div style={s.fieldGroup}>
                ...
                <input className="lex-input" type="text" placeholder="Your full name"
                  value={form.name} onChange={e => setForm({...form, name: e.target.value})} required />
              </div>
              <div style={s.fieldGroup}>
                <label style={s.label}>Email Address</label>
                <input className="lex-input" type="email" placeholder="you@example.com"
                  value={form.email} onChange={e => setForm({...form, email: e.target.value})} required />
              </div>
              <div style={s.fieldGroup}>
                <label style={s.label}>Password</label>
                <input className="lex-input" type="password" placeholder="Create a password"
...
const s = {
  ...
  leftOverlay: { position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(18,16,10,0.95) 0%, rgba(18,16,10,0.85) 60%, rgba(18,16,10,0.7) 100%)' },
  leftContent: { position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', padding: '40px 48px', justifyContent: 'space-between' },
  logoWrap: { display: 'flex', alignItems: 'center', gap: '12px' },
  logoIcon: { width: '40px', height: '40px', borderRadius: '10px', background: 'linear-gradient(135deg, rgba(201,168,76,0.15), rgba(201,168,76,0.08))', border: '1px solid rgba(201,168,76,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' },
  logoText: { fontFamily: "'Playfair Display', serif", fontSize: '22px', fontWeight: '700', background: `linear-gradient(135deg, #F0EDE8, ${GOLD})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' },
  ...
  leftH1: { fontFamily: "'Playfair Display', Georgia, serif", fontSize: 'clamp(32px, 4vw, 52px)', fontWeight: '800', lineHeight: '1.1', color: '#F0EDE8', letterSpacing: '-0.02em', marginBottom: '16px' },
  leftEm: { fontStyle: 'italic', background: `linear-gradient(135deg, ${GOLD}, #E2C47A)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' },
  ...
  statV: { fontSize: '20px', fontWeight: '800', color: GOLD, minWidth: '48px' },
  statL: { fontSize: '13px', color: '#555540' },
  ...
  right: { display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 40px', background: '#0E0C07', borderLeft: `1px solid ${BORDER}` },
  ...
  formTitle: { fontFamily: "'Playfair Display', Georgia, serif", fontSize: '28px', fontWeight: '700', color: '#F0EDE8', letterSpacing: '-0.02em', marginBottom: '6px' },
  formSub: { fontSize: '14px', color: '#444430' },
  errorBox: { background: 'rgba(224,82,82,0.08)', border: '1px solid rgba(224,82,82,0.2)', borderLeft: '2px solid #E05252', color: '#E05252', padding: '12px 14px', borderRadius: '8px', fontSize: '13px', marginBottom: '20px', lineHeight: '1.5' },
  form: { display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '20px' },
  fieldGroup: { display: 'flex', flexDirection: 'column', gap: '6px' },
  label: { fontSize: '11px', fontWeight: '600', color: '#555540', textTransform: 'uppercase', letterSpacing: '0.1em' },
